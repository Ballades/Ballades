...
public class RunActivity extends Activity implements OnClickListener, OnEditorActionListener, SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void startAudio() {
        ...
        try {
            ...
            pdService.startAudio(new Intent(this, RunActivity.class), R.drawable.icon, name, "Return to " + name + ".");
        } catch (IOException e) {
            toast(e.toString());
        }
    }
